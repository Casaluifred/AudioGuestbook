...
// GLOBALS
// Audio-Initialisierungscode kann über die GUI-Schnittstelle unter generiert werden https://www.pjrc.com/teensy/gui/
// Inputs
AudioSynthWaveform          waveform1; // erstellt den „Beep“-SFX
AudioInputI2S               i2s2; // I2S-Eingang vom Mikrofon am Audio-Shield
AudioPlaySdWavX              playWav1; // Spielt eine 44,1-kHz-16-Bit-PCM-Begrüßungs-WAV-Datei ab
AudioRecordQueue            queue1; // Erstellt vor dem Speichern auf SD einen Audiopuffer im Speicher
AudioMixer4                 mixer; // Ermöglicht das Zusammenführen mehrerer Eingaben zu derselben Ausgabe
AudioOutputI2S              i2s1; // I2S-Schnittstelle zum Lautsprecher/Line-Out am Audio-Shield
